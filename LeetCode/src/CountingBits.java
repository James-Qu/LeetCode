...
Total Accepted: 43405
Total Submissions: 74349
Difficulty: Medium
...
Divide the numbers in ranges like [2-3], [4-7], [8-15] and so on. And try to generate 
new range from previous.
Or does the odd/even status of the number help you in calculating the number of 1s?*/
public class CountingBits {
    public int[] countBits(int num) {
        //each number 1 count is (n&n-1)'s 1 count+1
